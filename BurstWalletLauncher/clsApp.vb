...
#Region " Detection "
    ...
    Private Sub Launcher()
        ...
        Catch ex As Exception
            If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(1, ex.Message)
        End Try
    End Sub
    Private Sub Nrs()
        ...
        Try
            ...
            End If
        Catch ex As Exception
            If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(17, ex.Message)
        End Try
    ...
    Private Sub JavaInstalled()
        ...
        Try
            ...
            p.Dispose()
        Catch ex As Exception
            If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(18, ex.Message)
        End Try
    ...
    Private Sub JavaPortable()
        Try
            ...
            End If
        Catch ex As Exception
            If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(19, ex.Message)
        End Try
    End Sub
    Private Sub MariaDB()
        Try
            ...
            End If
        Catch ex As Exception
            If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(20, ex.Message)
        End Try
    End Sub
#End Region
...
#Region " Download and unpack "
    ...
    Private Function Download(ByVal AppId As Integer, Optional ByVal FromRepos As Boolean = True) As Boolean
        ...
        For x = 0 To UBound(_Repositories) 'try next repo if fail.
            Try
                ...
                DLOk = True
            Catch ex As Exception
                If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(21, ex.Message)
            End Try
            Try
                File.Close()
            Catch ex As Exception
                If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(22, ex.Message)
            End Try
            'we need to cleanup
    ...
    Private Function Extract(ByVal AppId As Integer) As Boolean
        ...
        Try
            ...
            Archive.Dispose()
        Catch ex As Exception
            If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(23, ex.Message)
        End Try
    ...
    Private Sub DeleteFile(ByVal appid As Integer)
        Try
            ...
            End If
        Catch ex As Exception
            If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(24, ex.Message)
        End Try
    End Sub
...
#Region " Misc Functions "
    ...
    Public Function CheckOpenCL()
        Try
            ...
            End If
        Catch ex As Exception
            If BWL.Generic.DebugMe Then BWL.Generic.WriteDebug(25, ex.Message)
        End Try
        Return False
    End Function
#End Region
